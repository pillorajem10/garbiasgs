export const HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Soil investigation identifies bearing capacity, groundwater, and subsurface risks so foundations are designed for safety, compliance, and long-term stability.",
  },
  {
    question: "Does GarBia serve projects outside Metro Manila?",
    answer:
      "Yes. GarBia Group serves clients throughout Luzon and the Philippines with field teams for site investigation and foundation works.",
  },
];
...
export const SERVICES_FAQ = [
  ...
  },
  {
    ...
    answer:
      "When shallow soils cannot support design loads—common on soft ground, slopes, or high-rise and infrastructure projects.",
  },
  {
